...
"""
    ...
    environment {
        IMAGE_NAME = 'songhyunkwang/pai-service-insight'
                    ...
                    script {
                        ...
                        withCredentials([usernamePassword(credentialsId: 'github-credentials',
                            ...
                            sh """
                                ...
                                sed -i 's|image: ${IMAGE_NAME}:.*|image: ${IMAGE_NAME}:${IMAGE_TAG}|g' k8s/base/insight-service-deploy.yaml

                                # Commit and push
                                git add k8s/base/insight-service-deploy.yaml
                                git commit -m "Update insight-service image to ${IMAGE_TAG}" || echo "No changes to commit"
